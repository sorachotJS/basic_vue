    ...
    <header class="fixed w-full bg-white shadow-md" x-data="{menuOpen: false}">
        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                ...
                <a href="/about" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">เกี่ยวกับเรา</a>
                <a href="/portfolio" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">ผลงาน</a>
                <a href="/service" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">บริการ</a>
                <a href="/contact" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">ติดต่อเรา</a>
                <a href="/register" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block">สมัครสมาชิก</a>
                <div class="inline-block px-4 py-2">
                    <a href="/login" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">เข้าสู่ระบบ</a>
                </div>
            </div>
        </nav>
